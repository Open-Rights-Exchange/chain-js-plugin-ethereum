...
;(async () => {
  try {
    ...
    const composeEthTransferParams: EthTransferParams = {
      to: Helpers.toChainEntityName('0x27105356F6C1ede0e92020e6225E46DC1F496b81'),
      value: '0.000000000000000001',
    }

    const composeTokenTransferParams: Models.TokenTransferParams = {
      contractName: Helpers.toChainEntityName('0x04825941Ad80A6a869e85606b29c9D25144E91e6'),
      toAccountName: Helpers.toChainEntityName('0x27105356F6C1ede0e92020e6225E46DC1F496b81'),
    ...
    console.log(`actual cost of tx in ETH - available once tx is processed: ${await transaction.actualCost}`) // getActualCost will throw if called before tx is commited to chain
