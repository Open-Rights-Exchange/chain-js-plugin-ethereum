...
export class EthereumAccount implements Interfaces.Account {
  ...
  get canBeRecycled(): boolean {
    return Helpers.notSupported('EthereumAccount.canBeRecycled')
  }
