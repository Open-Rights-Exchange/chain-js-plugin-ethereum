...
export type EthereumDate = string & Models.ChainDateBrand // Datetime string in the format YYYY-MM-DDTHH:MM:SS.sss
export type EthereumEntityName = string & Models.ChainEntityNameBrand
export type EthereumSymbol = string & Models.ChainSymbolBrand
