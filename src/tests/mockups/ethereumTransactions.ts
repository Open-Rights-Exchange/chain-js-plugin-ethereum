...
export const { account1, permission1, account2 } = chainConfig.eth_ropsten
...
export const actionSendTokenEthereum = (fromAccount: string, toAccount: string) => {
  return {
    from: fromAccount,
    to: toAccount,
    contract: {
      abi: ERC20ABI,
      parameters: ['0xa26f803334002cbd7ddee757e95e684e417901e9', 1],
      method: 'transfer',
    },
  }
}
